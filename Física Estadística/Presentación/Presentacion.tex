...
\begin{frame}
	...
	\begin{equation}
		\rho \, d^3\kv = \Delta n_x \Delta n_y \Delta n_z = \left(\frac{L_x}{2\pi}d\kappa_x \right) \left(\frac{L_y}{2\pi}d\kappa_y \right) \left(\frac{L_z}{2\pi}d\kappa_z \right) = \frac{V}{(2\pi)^3}d^3\kv
		\label{eq:NumEstados}
	\end{equation}
\end{frame}

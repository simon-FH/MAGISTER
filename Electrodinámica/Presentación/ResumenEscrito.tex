...
\begin{document}
	...
	Si la fase de una partícula de carga $q$ moviéndose a través de un potencial $\n{A}$ en una trayectoria cerrada alrededor de la línea es trivial (es decir, igual a 1), entonces  el \textit{Dirac string} no es observable:
	\begin{equation}
		\exp\left[\frac{i q}{\hbar c} \oint \n{A} \cdot d\n{l}\right] = \exp\left[\frac{i q \cdot 4\pi g}{\hbar c} \right] = 1
	\end{equation}
	En consecuencia:
	\begin{equation}
		\frac{ 4\pi q g}{\hbar c} = 2\pi n, ~~ n \in \mathbb{Z},
	\end{equation}
	...
	\subsection{Condensados de Bosé-Einstein (BEC)}
	...
	En el caso específico de este artículo, se utiliza un gas compuesto por $\sim 1.8 \times 10^5$ átomos de Rubidio-87 para crear un condensado de Bosé Einstein espinorial, es decir, la ecuación de onda podrá ser descompuesta en una fase escalar y una de espín. Gracias a esta fase de espín, tendremos un campo espinorial o \textit{textura espinorial}, la cual asignará, en cada punto del espacio, una probabilidad a los valores de momento posibles.
	...
	\end{equation}
	donde $b_q > 0$ es la fuerza del campo cuadrupolar, y $B_z(t)$ es un campo uniforme que será podrá ser variado para efectivamente mover verticalmente es

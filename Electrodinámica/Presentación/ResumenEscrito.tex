...
%opening
\title{\vspace{-1.4cm}Observation of Dirac monopoles in a synthetic magnetic field\vspace{-3mm}}
\author{\vspace{-5mm}}
\date{\vspace{-10mm}}
...
%	\subsection{Condensado de Bosé-Einstein (BEC)}
	...
	\end{equation}
	Gracias a esta fase de espín, tendremos un campo espinorial o \textit{textura espinorial} ($\zeta(\rv,t)$), la cual asignará, en cada punto del espacio, una probabilidad a los posibles valores del número cuántico magnético.
...
%	Algunos sistemas exóticos compuestos por partículas neutras, como grupos de fotones, átomos ultrafríos o condensados de Bosé-Eisntein, pueden ser diseñados y manipulados para que se comporten como si estuvieran en presencia de un campo magnético, obedeciendo las mismas ecuaciones que uno real.
...
%	\subsection{Problema físico}
	...
	\end{equation*}
	donde el primer término corresponde a la contribución del monopolo y el segundo a la de la línea de vórtice. Si nos fijamos solo en el segundo término, y los comparamos con la ec. \ref{2pin}, obtendremos que la acumulación de fase, debido a la línea de vórtice, en la región $+z'$ es $\Delta \phi = 4 \pi$.
	...
	Pero, ya que el segundo término corresponde a la singularidad en $\n{A}^*$ a lo largo de la línea de vórtice, la cual es un artefacto de gauge, puede eliminarse dejando únicamente el campo monopolar. El campo será entonces
	\begin{equation}
...
%	\subsection{Medición}
	...
	Este artículo combina fuertemente elementos de mecánica estadística, mecánica cuántica y electrodinámica. Algunas de las herramientas de electrodinámica utilizadas son el teorema de Stokes, la ley de Faraday, los potenciales vectoriales (con la teoría de invarianza de gauge), y las ecuaciones de Maxwell.
	...
	También es notable el acuerdo entre datos experimentales y simulaciones, las cuales fueron construidas sin parámetros libres.
	...
	Una de las cosas más destacadas del desarrollo teórico de este artículo es la elegancia de Dirac al teorizar su monopolo, el cual puede ser entendido y desarrollado casi en su totalidad con las herramientas de la electrodinámica clásica.
	
	Respecto al desarrollo propio de este artículo, es interesante notar que, si bien la construcción e identificación de los campos sintéticos depende de conceptos salidos de la mecánica cuántica y estadística, una vez son logrados se comportan de la misma forma que un campo electromagnético real, siguiendo las ecuaciones de Maxwell.

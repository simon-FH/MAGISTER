...
\begin{document}
	...
	Se crean experimentalmente monopolos de Dirac en el campo electromagnético sintético que surge en el contexto de un condensado de Bose-Einstein (BEC) ferromagnético de $^{87}\mathrm{Rb}$ de espín 1 en un estado excitado diseñado específicamente.
